...
test("Paste text macro JIVE-599", function() {
	...
	ed.execCommand('mceInsertClipboardContent', false, {content : '<a ___default_attr="2002" _modifiedtitle="Mr User2" class="jive_macro jive_macro_user active_link" _mce_href="javascript:;" title="Mr User2">Mr User2</a><br/>'});
	equals(ed.getContent(), '<p>1<a class="jive_macro jive_macro_user active_link" href="javascript:;" title="Mr User2" jivemacro="user" ___default_attr="2002" _modifiedtitle="Mr User2">Mr User2</a>4</p>');
});
...
test("Paste content with style tag JIVE-465", function() {
    ...
    equals(ed.getContent().replace(/[\r\n]+/g, ''), '<p>1</p><p>Name: User Search</p><p>4</p>');
});
...
test("Paste large list from Word", function() {
    ...
    equals($j(content).find("p:nth(1)").attr("align"), "", "sub title is not centered");
    ...
    equals($j(content).find("p:nth(2)").attr("align"), "", "sub title is not centered");
    ...
    equals($j(content).find("p:nth(3)").attr("align"), "", "sub title is not centered");
    ...
    equals($j(content).find("p:nth(5)").attr("align"), "", "sub title is not centered");
...
test("only strip out Word classes, not any other classes 1", function() {
    ...
    equal(ed.getContent().replace(/[\r\n]+/g, ''), '<p><a class=\"jive_macro default_title jive_macro_message\" href=\"javascript:;\" jivemacro=\"message\" ___default_attr=\"1017\">awesome!</a></p><p> </p>');
});
...
test("Paste in bulleted lists", function() {
    ...
    ed.plugins.jiveselection.normalizeSelection();
...
/**
 * this is caused by tiny_mce_src taking nodes that are entirely made up of whitespace and replacing them
 * with a node that contains a single space. in FF/Safari/Chrome, the nonbreaking space is considered part of \s, whereas in IE
 * it is not. tiny_mce_src was modified to match IEs behavior with \s
 */
...
if(!tinymce.isIE){
    test("Paste Excel to Chrome", function(){
        ...
        var expected = "<table><tbody><tr><td>Heading 1</td><td>heading 2</td></tr><tr><td>1</td><td>a</td></tr><tr><td>2</td><td>b</td></tr><tr><td>3</td><td></td></tr><tr><td></td><td>d</td></tr><tr><td></td><td></td></tr></tbody></table>";
    ...
    test("Paste Excel to NodePad to RTE", function(){
        ...
        var actual = ed.getContent().replace(/[\r\n]+/g, '').replace(/<p> <\/p>/i, '').replace(/^<body>/i, '').replace(/^<\/body>/i, '').replace(/<br \/>/g, '');
        var expected = "<table><tbody><tr><td>Heading 1</td><td>heading 2</td></tr><tr><td>1</td><td>a</td></tr><tr><td>2</td><td>b</td></tr><tr><td>3</td><td></td></tr><tr><td></td><td>d</td></tr></tbody></table>";
        equals(actual, expected);
    });
}
...
if(tinymce.isGecko){
    test("Paste Excel to FF", function(){
        ...
        var actual = ed.getContent().replace(/[\r\n]+/g, '').replace(/<p> <\/p>/i, '').replace(/^<body>/i, '').replace(/^<\/body>/i, '').replace(/<br \/>/g, '');
        var expected = "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"128\"><tbody><tr><td height=\"17\" width=\"64\">Heading 1</td><td width=\"64\">heading 2</td></tr><tr><td align=\"right\" height=\"17\">1</td><td>a</td></tr><tr><td align=\"right\" height=\"17\">2</td><td>b</td></tr><tr><td align=\"right\" height=\"17\">3</td><td></td></tr><tr><td height=\"17\"></td><td>d</td></tr><tr><td height=\"17\"></td><td></td></tr></tbody></table>";
        equals(actual, expected);
    });
}
