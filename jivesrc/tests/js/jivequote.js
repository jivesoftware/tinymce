...
test("insert empty quote", function() {
	...
	equals(ed.getContent(), '<p>first </p>\n<pre class=\"jive_text_macro jive_macro_quote\" jivemacro=\"quote\"><p> </p></pre>\n<p> </p>');
});
...
test("Backspace at front of quote.", function() {
	ed.setContent('<pre class=\"jive_text_macro jive_macro_quote\" jivemacro=\"quote\"><p>first </p></pre><p> </p>');
	...
	checkContent(ed, '<p>first </p><p> </p>', "content");
});
