...
if(!tinymce.isIE){
    test("outdent on backspace, last list item (empty), top-level list", function() {
        ed.setContent('<ul><li>first</li><li>second</li><li></li></ul>');
        ...
        equals(ed.getContent().replace(/[\r\n]+/g, ''), '<ul><li>first</li><li>second</li></ul><p> </p>');

        var expectedRng = ed.dom.createRng();
        expectedRng.setStart(ed.getBody().lastChild, 0);
...
test("List style change", function(){
    ed.setContent('<ol _mce_style="list-style-type: lower-roman;" style="list-style-type: lower-roman;"><li>first</li></ol>');
...
test("list creation inside a table cell", function(){
    ...
    checkContent(ed, '<table border=\"1\" class=\"jiveBorder\" style=\"border: 1px solid #000000; width: 100%;\"><tbody><tr><th style=\"text-align: center; background-color: #6690bc; color: #ffffff; padding: 2px;\" valign=\"middle\"><strong>Header 1</strong></th><th style=\"text-align: center; background-color: #6690bc; color: #ffffff; padding: 2px;\" valign=\"middle\"><strong>Header 2</strong></th> </tr><tr><td id=\"list-cell\" style=\"padding: 2px;\"><ul><li>List item</li></ul></td><td style=\"padding: 2px;\"></td></tr><tr><td style=\"padding: 2px;\"><br /></td><td style=\"padding: 2px;\"><br /></td></tr></tbody></table><p> </p>');
...
test("list creation inside an empty table cell", function(){
    ...
    checkContent(ed, '<table border=\"1\" class=\"jiveBorder\" style=\"border: 1px solid #000000; width: 100%;\"><tbody><tr><th style=\"text-align: center; background-color: #6690bc; color: #ffffff; padding: 2px;\" valign=\"middle\"><strong>Header 1</strong></th><th style=\"text-align: center; background-color: #6690bc; color: #ffffff; padding: 2px;\" valign=\"middle\"><strong>Header 2</strong></th> </tr><tr><td id=\"list-cell\" style=\"padding: 2px;\"><ul><li></li></ul></td><td style=\"padding: 2px;\"></td></tr><tr><td style=\"padding: 2px;\"><br /></td><td style=\"padding: 2px;\"><br /></td></tr></tbody></table><p> </p>');
