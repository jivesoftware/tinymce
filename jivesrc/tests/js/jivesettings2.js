...
jive.statusinput.dropdown.ddLoading = function(opt_data, opt_sb) {
	...
	output.append('<div class="j-autocomplete j-popover j-js-autocomplete"><div class="j-top-pointer"></div><div class="loading"></div></div>');
...
window.jive_settings = {
        ...
        plugins : "jiveutil,jivescroll,jiveresize,jiveblackout,jivecontextmenu,jivebuttons,jiveemoticons,jivestyle,jivelink,jivequote,jivevideo,jiveimage,spellchecker,html,style,jivelists,table,jivetablecontrols,save,advimage,advlink,inlinepopups,jivemacros,paste,jivemention,jiveselection,jivetable,jivetablebutton,jivemouse",
