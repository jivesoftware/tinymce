        ...
        init : function(ed, url) {
            ...
            ed.onKeyPress.add(function(ed, evt){
                ...
                if(this.prepForLargeDel){
                    ...
                    rng = ed.plugins.jiveselection.getShrunkenBlockRange(rng, "tr, td, th");
                    ...
                    function removeEmptyNodeTree(n){
                        ...
                        if(n.hasChildNodes()){
                            ...
                            isEmpty = false;
                        }else if(ed.dom.is(n, "body, td, th")){
                            isEmpty = false;
                        }
                        if(isEmpty){
                    ...
                    if(ed.plugins.jiveselection.isEffectivelyEmpty(ed.getBody())){
